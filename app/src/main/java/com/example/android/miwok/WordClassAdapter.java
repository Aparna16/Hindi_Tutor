...
public class WordClassAdapter extends ArrayAdapter<Word>{

    public WordClassAdapter(Activity context, ArrayList<Word> words) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        numberTextView.setText(currentAndroidFlavor.getHindiTranslation());

        // Find the ImageView in the list_item.xml layout with the ID list_item_icon
       // ImageView iconView = (ImageView) listItemView.findViewById(R.id.list_item_icon);
        // Get the image resource ID from the current AndroidFlavor object and
        // set the image to iconView
        //iconView.setImageResource(currentAndroidFlavor.getImageSrc());
